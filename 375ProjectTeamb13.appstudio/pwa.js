...
const cacheName = '_75ProjectTeamb12-2021-11-02 13:13:39.200700'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, '_75ProjectTeamb12'.length) === '_75ProjectTeamb12') {
